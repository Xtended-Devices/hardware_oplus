package com.xtended.oplus.OPlusExtras.touch;
...
public class ActionUtils {
    ...
    private static Intent getOPlusExtrasIntent(Context context) {
        Intent intent = new Intent();
        ComponentName cn=new ComponentName("com.xtended.oplus.OPlusExtras",
                "com.xtended.oplus.OPlusExtras.OPlusExtrasActivity");
        intent.setComponent(cn);
        return intent;
    }
    ...
    public static void triggerAction(Context context, int action) {
        ...
        if (km.isKeyguardLocked()) {
            intent = new Intent();
            intent.setClassName("com.xtended.oplus.OPlusExtras", "com.xtended.oplus.OPlusExtras.touch.ScreenOffLaunchGestureActivity");
