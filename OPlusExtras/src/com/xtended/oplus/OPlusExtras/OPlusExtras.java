...
package com.xtended.oplus.OPlusExtras;
...
import com.xtended.oplus.OPlusExtras.doze.DozeSettingsActivity;
...
import com.xtended.oplus.OPlusExtras.services.*;
import com.xtended.oplus.OPlusExtras.slider.SliderConstants;
...
public class OPlusExtras extends PreferenceFragment
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        mHBMInfo.setOnPreferenceClickListener(preference -> {
            ...
            Drawable xtended = getResources().getDrawable(R.drawable.xtended,null);
             int randomColor;
             randomColor = Color.rgb(
             Color.red(rand.nextInt(0xFFFFFF)),
             Color.green(rand.nextInt(0xFFFFFF)),
             Color.blue(rand.nextInt(0xFFFFFF)));
             xtended.setTint(randomColor);

            ParticleSystem ps = new ParticleSystem(getActivity(),50,xtended,2000);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mAutoHBMSwitch) {
            ...
            Intent fpsinfo = new Intent(this.getContext(),
                    com.xtended.oplus.OPlusExtras.services.FPSInfoService.class);
            if (enabled) {
